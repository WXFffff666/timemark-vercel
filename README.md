...
[![Version](https://img.shields.io/badge/Version-2.13.0-blue?style=flat&color=2563eb)](https://github.com/WXFffff666/timemark-vercel)
...
部署后数据库表会在 **首次 API 冷启动时自动迁移**（v1–v22）。也可手动执行：
...
部署完成后可在 **设置 → 部署向导** 查看「系统自检」（数据库连接、结构版本 v22、CRON_SECRET、Turnstile 等）。
